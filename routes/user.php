...
Route::middleware(['auth', 'userMiddleware'])->group(function (): void {
   ...
   Route::post('/dashboard/ticketes/add',[TicketsController::class,'store'])->name('employee.tickets.add');
   ...
   Route::get('dashboard/profile/edit', [UserController::class, 'editProfile'])->name('employee.profile.edits');
    ...
    Route::patch('/employee/tickets/edit/{id}',[TicketsController::class , 'update'])->name('employee.ticket.update');
