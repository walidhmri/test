<label class="block mt-4 text-sm">
    <span class="text-gray-700 dark:text-gray-100"> Current Password</span>
    <input name="current_password" type="password" placeholder="Enter current password" required
        class="block w-full mt-1 text-gray-400 text-sm dark:border-gray-600 dark:bg-gray-700 form-input" />
</label>

<label class="block mt-4 text-sm">
    <span class="text-gray-700 dark:text-gray-100">New Password</span>
    <input name="password" type="password" placeholder="Type new password" required
        class="block w-full mt-1 text-gray-400 text-sm dark:border-gray-600 dark:bg-gray-700 form-input" />

</label>
<label class="block mt-4 text-sm">
    <span class="text-gray-700 dark:text-gray-100">Confirm new Password</span>
