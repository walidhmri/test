    ...
    <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800">
        <form method="POST" action="{{ route('admin.faq.update', $faq) }}">
            ...
            <label class="block text-sm">
                ...
                <input name="question" type="text" value="{{ $faq->question }}" required autofocus class="block w-full text-gray-400 mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 form-input" placeholder="Example: What is the FAQ about?" />
            ...
            <label class="block mt-4 text-sm">
                ...
                <textarea name="answer" required class="block w-full mt-1 text-gray-400 text-sm dark:border-gray-600 dark:bg-gray-700 form-textarea" placeholder="Example: This is the answer to the FAQ.">{{ $faq->answer }}</textarea>
