...
<div class="container px-4 sm:px-6 mx-auto grid">
    ...
    <div class="grid gap-4 sm:gap-6 mb-6 sm:mb-8 grid-cols-1 sm:grid-cols-2 xl:grid-cols-4">
        <!-- Card -->
        <div class="flex items-center p-3 sm:p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
            <div class="p-2 sm:p-3 mr-3 sm:mr-4 text-orange-500 bg-orange-100 rounded-full dark:text-orange-100 dark:bg-orange-500">
            ...
            <div>
                ...
                <p class="text-base sm:text-lg font-semibold text-gray-700 dark:text-gray-200">
        ...
        <!-- Card -->
        <div class="flex items-center p-3 sm:p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
            <div class="p-2 sm:p-3 mr-3 sm:mr-4 text-green-500 bg-green-100 rounded-full dark:text-green-100 dark:bg-green-500">
        ...
        <!-- Card -->
        <div class="flex items-center p-3 sm:p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
            <div class="p-2 sm:p-3 mr-3 sm:mr-4 text-blue-500 bg-blue-100 rounded-full dark:text-blue-100 dark:bg-blue-500">
                <svg class="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
        ...
        <!-- Card -->
        <div class="flex items-center p-3 sm:p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
            <div class="p-2 sm:p-3 mr-3 sm:mr-4 text-teal-500 bg-teal-100 rounded-full dark:text-teal-100 dark:bg-teal-500">
                <svg class="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M10 2a4 4 0 100 8 4 4 0 000-8zM2 18a8 8 0 1116 0H2z"></path>
                </svg>
            </div>
    ...
    <div class="grid gap-4 sm:gap-6 mb-6 sm:mb-8 grid-cols-1 md:grid-cols-2">
            <div class="min-w-0 p-3 sm:p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
              <h4 class="mb-3 sm:mb-4 text-sm sm:text-base font-semibold text-gray-800 dark:text-gray-300">
            ...
            <div class="min-w-0 p-3 sm:p-4 bg-white rounded-lg shadow-xs dark:bg-gray-800">
              ...
              <div class="flex justify-center mt-3 sm:mt-4 space-x-2 sm:space-x-3 text-xs sm:text-sm text-gray-600 dark:text-gray-400">
                <!-- Chart legend -->
                <div class="flex items-center">
                  <span class="inline-block w-2 sm:w-3 h-2 sm:h-3 mr-1 bg-teal-600 rounded-full"></span>
                  <span>@lang('messages.solved')</span>
                </div>
                <div class="flex items-center">
                  <span class="inline-block w-2 sm:w-3 h-2 sm:h-3 mr-1 bg-purple-600 rounded-full"></span>
            ...
            <table class="w-full whitespace-nowrap">
              <thead>
                  <tr
                      ...
                      <th class="px-2 sm:px-4 py-2 sm:py-3">@lang('messages.date')</th>
                  </tr>
              </thead>
              <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                  ...
                  " class="px-1 sm:px-2 py-0.5 sm:py-1 text-xs font-semibold leading-tight rounded-full 
                      ...
                      <td class="px-2 sm:px-4 py-2 sm:py-3 text-xs">
                          ...
                          <span class="px-1 sm:px-2 py-0.5 sm:py-1 text-xs font-semibold leading-tight rounded-full 
